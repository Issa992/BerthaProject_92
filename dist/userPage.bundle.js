...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/js/UsersPage.ts");
/******/ })
/************************************************************************/
/******/ ({
...
var GetById = document.getElementById("getMyData");
GetById.addEventListener("click", getAll);
function getAll() {
    var IdInputElement = document.getElementById("inputId");
...
var EnviroById = document.getElementById("ShowHealthById");
var GetByIdE = document.getElementById("getMyEnviroData");
GetByIdE.addEventListener("click", getAllEnviro);
function getAllEnviro() {
    var IdInputElement = document.getElementById("inputId");
    var idElement = IdInputElement.value;
    var uri = "https://birthawebservice20181031094923.azurewebsites.net/api/environment/" + idElement;
    _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.get(uri)
        .then(function (response) {
        console.log(response.data.id);
        var result1 = "";
...
/******/ });
//# sourceMappingURL=userPage.bundle.js.map